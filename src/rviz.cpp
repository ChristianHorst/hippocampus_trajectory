...
rviz::rviz(ros::NodeHandle* nodehandle):nh(*nodehandle)
{
   ...
   void rviz::publishWalls(){
    ...
    //wall 1--------------------------------------------
        ...
        all_tank_walls.markers[0].scale.y = 2.0;
        all_tank_walls.markers[0].scale.z = 2.0;
        ...
        all_tank_walls.markers[0].pose.position.y = 1.0 ;
        all_tank_walls.markers[0].pose.position.z = 0.5 ; 
    //wall 2--------------------------------------------
       all_tank_walls.markers[1].scale.x = 0.005  ;
       all_tank_walls.markers[1].scale.y = 2.0;
       all_tank_walls.markers[1].scale.z = 2.0;
       ...
       all_tank_walls.markers[1].pose.position.x = 4.0; 
       all_tank_walls.markers[1].pose.position.y = 1.0 ;
       all_tank_walls.markers[1].pose.position.z = 0.5 ; 
    //wall 3--------------------------------------------2,2,0.5,0.707,0.707
       all_tank_walls.markers[2].scale.x = 0.005  ;
       all_tank_walls.markers[2].scale.y = 4.0;
       all_tank_walls.markers[2].scale.z = 2.0;
       ...
       all_tank_walls.markers[2].pose.position.x = 2.0; 
       all_tank_walls.markers[2].pose.position.y = 2.0 ;
       all_tank_walls.markers[2].pose.position.z = 0.5 ; 
    //wall 4--------------------------------------------2,0,0.5,0.707,0.707
       all_tank_walls.markers[3].scale.x = 0.005  ;
       all_tank_walls.markers[3].scale.y = 4.0;
       all_tank_walls.markers[3].scale.z = 2.0;
       ...
       all_tank_walls.markers[3].pose.position.x = 2.0; 
       all_tank_walls.markers[3].pose.position.y = 0.0 ;
       all_tank_walls.markers[3].pose.position.z = 0.5 ; 
